...
GH_REPO="$GH_API/repos/TXPGhost/markdown-preview.nvim"
...
do
  GH_ASSET="https://uploads.github.com/repos/TXPGhost/markdown-preview.nvim/releases/$id/assets?name=$filename"
